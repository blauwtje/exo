...
- A frame file written before any spawn, holding the done predicate, each worker's slice and output path, and the selection rule, gauntlet rule or arena rubric.
