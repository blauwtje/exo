# blast-radius: pass criteria for the `with` arm
...
No source states the outcome each case must reach. The lines below follow from steps 4, 5 and 7 of `skills/blast-radius/SKILL.md`, applied to the trap each fixture script names in its header comment.
