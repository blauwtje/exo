// The part of the using-exo body a long session hears again. The session hook
...
export const RESTATED_SKILL = 'skills/using-exo/SKILL.md';
export const RESTATED_HEADINGS = ['## Before acting', '## When several fire', '## The next stage'];
