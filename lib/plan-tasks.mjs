// Reads a plan as `define-scope` writes it and asks the checkout what landed:
...
// ` | ` from the depends value itself. `Files:`/`Data:`/`Design:`/`Proof:`
...
/** The plan cannot be ordered or read as define-scope writes it: the caller exits 1. */
