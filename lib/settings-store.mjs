...
// then the schema default. skills/settings/scripts/settings.mjs runs its CLI at
...
export const SCHEMA = JSON.parse(fs.readFileSync(new URL('../skills/settings/schema.json', import.meta.url), 'utf8'));
