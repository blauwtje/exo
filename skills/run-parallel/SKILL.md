...
- A path in the repository root's status after the run that step 4's baseline did not list outranks every green worker: the run lands or grafts nothing, even when every result passed.
