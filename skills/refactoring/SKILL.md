---
name: refactoring
description: "Use when a named refactor, rename, move or internal API reshape must keep behavior unchanged, or a shim or compatibility re-export tempts. Not for finding what to refactor, which deepen owns, a behavior change, which implementing-batch builds, or an unproven failure, which debug owns."
