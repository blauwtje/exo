...
4. **Write** nothing of your own above the fence, not the panel's `✻ exo savings` header and not the opening line an output style asks for: the panel is the whole answer, and a line above it repeats what the reader is about to read.
