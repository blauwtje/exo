---
name: investigation
description: "Use when asked how X works or why it is so, to explain, teach or confirm it, if a stated reason holds even when a comment gives it, for a PR verdict, runbook, ADR or doc. Not for locations (exo:explorer), libraries (research), unproven failures (debug) or restructuring (deepen)."
