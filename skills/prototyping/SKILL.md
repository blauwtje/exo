...
3. **Build the least that answers it.** One command runs it, and what it prints or shows is the observation step 1 named, so the answer is read off the run and never inferred.
