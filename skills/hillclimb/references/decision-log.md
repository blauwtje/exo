...
- `<common git dir>/exo/hillclimb/<slug>.tsv`, the directory from `git rev-parse --git-common-dir`, so every worktree of the run writes one file and nothing is committed.
