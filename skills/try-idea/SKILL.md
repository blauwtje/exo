...
2. **Sort logic from look.** A question about how logic, state or data behaves stays here; a question about what a surface looks like leaves for `design-ui`, which already builds rival directions.
