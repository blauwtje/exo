---
name: show-savings
description: Use when the user asks what exo saved, what the read guard kept out of context, or for the savings report or totals. Not for switching the counter or the guard, which configure owns, or one diff's size, which git shows.
...
- Not for switching the counter or the read guard, or for the guard's line limit: `configure` changes those.
