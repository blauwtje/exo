...
description: Collects the Phase 1 context of one full or bounded designing redesign, the three facts, durable design context, baseline record, content inventory, subject observations and FILES list, into the run directory. Dispatched once per run by designing. Not for a tweak, a new piece, a sketch, a direction choice, or any edit to the repository.
model: sonnet
effort: high
